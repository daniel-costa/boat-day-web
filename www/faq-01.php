					...
					<div class="row">
						<div class="col-sm-12 faq-col">
							...
							<ul class="list-unstyled">
								<li><a href="javascript:scrollToAnchor('#q-1')">How long is a BoatDay?</a></li>
								<li><a href="javascript:scrollToAnchor('#q-2')">How much does a BoatDay cost?</a></li>
								<li><a href="javascript:scrollToAnchor('#q-3')">How do I submit a BoatDay request?</a></li>
								<li><a href="javascript:scrollToAnchor('#q-4')">Can I cancel a pending request?</a></li>
								<li><a href="javascript:scrollToAnchor('#q-5')">Can I make changes to a pending request?</a></li>
