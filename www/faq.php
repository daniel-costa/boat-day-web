			...
			<div class="container block-space">
				<div class="col-md-20 col-md-offset-2 col-lg-18 col-lg-offset-3 block-space-bottom faq-list">
					<ul id="list-faq">
						...
						<ul>
							<li><a href="#hosts-1">How do I become a host?</a></li>
							<li><a href="#hosts-2">Are there any fees to become a Host?</a></li>
							<li><a href="#hosts-3">Host Background Screening</a></li>
							<li><a href="#hosts-4">How do I create a BoatDay?</a></li>
						...
						<ul>
							...
							<li><a href="#general-2">What is a "contribution"?</a></li>
							<li><a href="#general-3">How long is a BoatDay?</a></li>
							<li><a href="#general-4">What is the Trust &amp; Safety Fee?</a></li>
							<li><a href="#general-5">Ratings and Reviews</a></li>
							<li><a href="#general-6">Can I bring children?</a></li>
							<li><a href="#general-7">How BoatDay and BoatDay Hosts are Classified</a></li>
							<li><a href="#general-8">Using BoatDay with IOS 7 or older</a></li>
						</ul>
						<li><a href="#safety">Safety</a></li>
						<ul>
							<li><a href="#safety-1">What are the BoatDay safety features?</a></li>
							<li><a href="#safety-2">Boater Certifications</a></li>
							<li><a href="#safety-3">What is the BoatDay zero-tolerance drug and alcohol policy for Hosts?</a></li>
							<li><a href="#safety-4">I’m a Guest, what are some safety tips I can follow?</a></li>
							<li><a href="#safety-5">Reporting an incident or safety concern?</a></li>
							<li><a href="#safety-6">Emergency Boat Assistance</a></li>
							<li><a href="#safety-7">No-Weapons Policy</a></li>
						</ul>
					</ul>
					<div id="hosts" class="cat">
						...
						<div id="hosts-4" class="sub-cat">
							...
							<div class="sub-sub-cat">
								...
								<img src="images/boatday3.png"/><br>
							</div>
							<div class="sub-sub-cat">
								...
								<img src="images/boatday4.png"/><br>	
							</div>
							<div class="back-to-top">
								<a href="#list-faq">back <span class="glyphicon glyphicon-chevron-up"></span></a>
							</div>
						...
						<div id="hosts-5" class="sub-cat">
							...
							<p>The price you list for your BoatDay is completely up to you. Some Hosts browse comparable BoatDays in their area to get an idea of market prices.</p>
						...
						<div id="hosts-7" class="sub-cat">
							...
							<img src="images/boatday5.png"/><br>
							<div class="back-to-top">
								<a href="#list-faq">back <span class="glyphicon glyphicon-chevron-up"></span></a>
							</div>
						</div>
						...
						<div id="hosts-13" class="sub-cat">
							...
							<div class="sub-sub-cat">
								...
								<p>When registering a Boat on your Host Account, add the email address of your trusted Captain to invite him/her to join BoatDay and Captain your Boat.  If the Captain accepts your invitation, creates a BoatDay Account, and passes our screening process, he/she will be approved to Captain your boat.</p>
					...
					<div id="guests" class="cat">
						...
						<div id="guests-2" class="sub-cat">
							...
							<div class="sub-sub-cat">
								...
								<p>For some listings, you'll be able to book without receiving approval from the Host by using Instant Booking.</p>
							</div>
							<div class="back-to-top">
								<a href="#list-faq">back <span class="glyphicon glyphicon-chevron-up"></span></a>
							</div>
					...
					<div id="general" class="cat">
						...
						<div id="general-8" class="sub-cat">
