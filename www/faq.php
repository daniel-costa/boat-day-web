				...
				<div class="col-md-20 col-md-offset-2 col-lg-18 col-lg-offset-3 block-space-bottom faq-list">
					...
					<div id="hosts" class="cat">
						...
						<div id="hosts-1" class="sub-cat">
							<h2 id="becomeHost">Can I be a Host?</h2>
							...
							<div class="sub-sub-cat">
								<h4>REQUIREMENTS FOR BECOMING A HOST?</h4>
								<ul>
						...
						<div id="hosts-3" class="sub-cat">
							<h2>Will BoatDay work for my Charter Business? </h2>
						...
						<div id="hosts-10" class="sub-cat">
							<h2 id="cancellationPolicy">What if a Guest cancels?</h2>
						...
						<div id="hosts-12" class="sub-cat">
							<h2 id="duplicateBoatday">Duplicating a BoatDay</h2>
							...
							<img src="images/dupBoatday.png"/><br>
						</div>
						...
						<div id="hosts-15" class="sub-cat">
							...
							<div class="sub-sub-cat">
								<h4 id="registerCaptain">HOW TO ADD A CAPTAIN FOR YOUR BOATDAYS</h4>
								...
								<img src="images/addCaptain.png"/><br>
						...
						<div id="hosts-17" class="sub-cat">
							...
							<div class="sub-sub-cat">
								<h4 id="proofOfInsurance">ACCOUNT PHOTOS: PROOF OF BOAT INSURANCE</h4>
					...
					<div id="guests" class="cat">
						...
						<div id="guests-8" class="sub-cat">
							<h2 id="response">How long does a Host have to respond to my BoatDay request?</h2>	
