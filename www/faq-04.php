					...
					<div class="row">
						<div class="col-sm-12 faq-col">
							...
							<ul class="list-unstyled">
								<li><a href="javascript:scrollToAnchor('#q-1')">What is a "contribution"?</a></li>
								<li><a href="javascript:scrollToAnchor('#q-2')">How do payments work?</a></li>
								<li><a href="javascript:scrollToAnchor('#q-3')">How do Hosts get paid?</a></li>
								<li><a href="javascript:scrollToAnchor('#q-4')">Payment Issues</a></li>
								<li><a href="javascript:scrollToAnchor('#q-5')">Receipts</a></li>
							</ul>
						</div>
					</div>
				</div>
